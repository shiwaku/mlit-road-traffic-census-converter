...
from census_converter.download import download_kasho_csv  # noqa: E402


def main() -> None:
    p = argparse.ArgumentParser(description="箇所別基本表CSVのダウンロード")
    ...
    print(f"保存先: {cfg.kasho_dir}")
    download_kasho_csv(cfg, skip_existing=not args.force)
